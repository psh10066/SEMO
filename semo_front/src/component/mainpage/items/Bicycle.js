...
export function Bicycle(props) {
  ...
  const { nodes, materials } = useGLTF("./models/bycircle/model.gltf");
  return (
    <group>
        ...
        <mesh geometry={nodes.Bike.geometry} material={nodes.Bike.material}>
          ...
          >
            ...
            <mesh
              ...
              material={nodes.Torus003_1.material}
            />
            <mesh
              geometry={nodes.Torus003_2.geometry}
              material={nodes.Torus003_2.material}
            />
          </group>
          <group
          ...
          <mesh
            ...
            material={nodes.CaboFreioFrente.material}
          ...
          >
            ...
            <mesh
              ...
              material={nodes.Torus002_1.material}
            />
            <mesh
              geometry={nodes.Torus002_2.geometry}
              material={nodes.Torus002_2.material}
            />
          </group>
          <mesh
          ...
          <mesh
            ...
            material={nodes.B_Raios.material}
            position={[-1.05, -1.18, 0]}
          />
          <mesh
            geometry={nodes.F_Raios.geometry}
            material={nodes.F_Raios.material}
            position={[1.9, -1.18, 0]}
          />
        </mesh>
      </animated.group>
